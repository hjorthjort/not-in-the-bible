...
Cross-platform polling bot adapters live under `bots/`.
...
See [`bots/README.md`](bots/README.md) for the required environment variables, screenshot setup, and continuous-run requirements.
